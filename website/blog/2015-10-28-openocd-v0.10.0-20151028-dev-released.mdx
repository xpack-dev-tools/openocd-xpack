...
description: Version 0.10.0-201510281129-dev is a maintenance release of GNU ARM Eclipse OpenOCD.
keywords:
  - xpack
  - openocd
  - release
...
Version **0.10.0-201510281129-dev** is a maintenance release.
