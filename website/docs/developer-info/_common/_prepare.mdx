...
<ul>
<li><a href={ `https://github.com/xpack-dev-tools/${ siteConfig.customFields.appLcName }-xpack.git` }>{ `https://github.com/xpack-dev-tools/${ siteConfig.customFields.appLcName }-xpack.git` }</a></li>
</ul>
...
`rm -rf ~/Work/xpack-dev-tools/${ siteConfig.customFields.appLcName }-xpack.git && \\
git clone https://github.com/xpack-dev-tools/${ siteConfig.customFields.appLcName }-xpack.git \\
  ~/Work/xpack-dev-tools/${ siteConfig.customFields.appLcName }-xpack.git`
}</CodeBlock>
...
git clone \\
  ...
  https://github.com/xpack-dev-tools/${ siteConfig.customFields.appLcName }-xpack.git \\
  ~/Work/xpack-dev-tools/${ siteConfig.customFields.appLcName }-xpack.git`
}</CodeBlock>
