...
export const gitUrl = `https://github.com/xpack-dev-tools/${ customFields.appLcName }-xpack.git`
...
`rm -rf ~/Work/xpack-dev-tools/${ customFields.appLcName }-xpack.git && \\
git clone https://github.com/xpack-dev-tools/${ customFields.appLcName }-xpack.git \\
  ~/Work/xpack-dev-tools/${ customFields.appLcName }-xpack.git`
}</CodeBlock>
...
git clone \\
  ...
  https://github.com/xpack-dev-tools/${ customFields.appLcName }-xpack.git \\
  ~/Work/xpack-dev-tools/${ customFields.appLcName }-xpack.git`
}</CodeBlock>
