...
`  "xpack": {
    ...
    "dependencies": {},
    "devDependencies": {
      "@xpack-dev-tools/${ siteConfig.customFields.appLcName }": {
        "specifier": "${ siteConfig.customFields.upstreamVersion }-${ siteConfig.customFields.xpackSubversion }.${ siteConfig.customFields.npmSubversion }",
        "local": "link",
        "platforms": "all"
      }
    },
...
**xPack { siteConfig.customFields.appName }**.
