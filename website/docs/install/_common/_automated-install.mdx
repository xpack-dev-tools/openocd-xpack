...
The easiest (and recommended) way to install OpenOCD on { props.label } is by using the **binary xPack**, available as
<a href={ `https://www.npmjs.com/package/@xpack-dev-tools/openocd` }><code>@xpack-dev-tools/openocd</code></a>
