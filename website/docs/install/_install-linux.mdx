...
`$ tree -L 2 ~/.local/xPacks/\@xpack-dev-tools/openocd/${ customFields.upstreamVersion }-${ customFields.xpackSubversion }.${ customFields.npmSubversion }/.content/
/home/ilg/.local/xPacks/\@xpack-dev-tools/openocd/${ customFields.upstreamVersion }-${ customFields.xpackSubversion }.${ customFields.npmSubversion }/.content/
├── README.md
├── bin
│   └── openocd
├── distro-info
...
To check if the { customFields.appName } installed by **xpm** starts properly, use something like:
...
To check if the { customFields.appName } installed manually starts properly, use something like:
