...
`$ ~/.local/xPacks/@xpack-dev-tools/openocd/${ customFields.upstreamVersion }-${ customFields.xpackSubversion }.${ customFields.npmSubversion }/.content/bin/openocd --version
${ customFields.upstreamVersion }`
}</CodeBlock>
...
to <code>~/.local/xPacks/openocd/xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/openocd
cd ~/.local/xPacks/openocd

tar xvf ~/Downloads/xpack-openocd-${ customFields.upstreamVersion }-${ customFields.xpackSubversion }-linux-x64.tar.gz
chmod -R -w xpack-openocd-${ customFields.upstreamVersion }-${ customFields.xpackSubversion }`
}</CodeBlock>
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/openocd/xpack-openocd-${ customFields.upstreamVersion }-${ customFields.xpackSubversion }/bin/openocd --version
${ customFields.upstreamVersion }`
}</CodeBlock>
...
`sudo cp ~/.local/xPacks/@xpack-dev-tools/openocd/${ customFields.upstreamVersion }-${ customFields.xpackSubversion }.${ customFields.npmSubversion }/.content/contrib/60-openocd.rules /etc/udev/rules.d/`
}</CodeBlock>
