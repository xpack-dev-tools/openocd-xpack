...
<InstallLinuxTree upstreamVersion={props.upstreamVersion} xpackSubversion={props.xpackSubversion} npmSubversion={props.npmSubversion}/>
...
* <code>xpack-openocd-{ props.upstreamVersion }-{ props.xpackSubversion }-linux-x64.tar.gz</code>
* <code>xpack-openocd-{ props.upstreamVersion }-{ props.xpackSubversion }-linux-arm.tar.gz</code>
* <code>xpack-openocd-{ props.upstreamVersion }-{ props.xpackSubversion }-linux-arm64.tar.gz</code>
...
to <code>~/.local/xPacks/openocd/xpack-openocd-{ props.upstreamVersion }-{ props.xpackSubversion }</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/openocd
cd ~/.local/xPacks/openocd

tar xvf ~/Downloads/xpack-openocd-${ props.upstreamVersion }-${ props.xpackSubversion }-linux-x64.tar.gz
...
<CodeBlock language="console"> {
`$ ~/.local/xPacks/openocd/xpack-openocd-${ props.upstreamVersion }-${ props.xpackSubversion }/bin/openocd --version
${ props.upstreamVersion }`
}</CodeBlock>
...
`sudo cp ~/.local/xPacks/@xpack-dev-tools/openocd/${ props.upstreamVersion }-${ props.xpackSubversion }.${ props.npmSubversion }/.content/contrib/60-openocd.rules /etc/udev/rules.d/`
}</CodeBlock>
