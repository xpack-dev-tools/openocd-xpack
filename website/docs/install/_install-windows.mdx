...
`C:\> tree /f %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\openocd\\${ customFields.upstreamVersion }-${ customFields.xpackSubversion }.${ customFields.npmSubversion }\\.content
Folder PATH listing
...
<CodeBlock language="console"> {
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\openocd\\${ customFields.upstreamVersion }-${ customFields.xpackSubversion }.${ customFields.npmSubversion }\\.content\\bin\\openocd.exe --version
...
<CodeBlock language="console"> {
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\openocd\\xpack-openocd-${ customFields.upstreamVersion }-${ customFields.xpackSubversion }\\bin\\openocd.exe --version
${ customFields.upstreamVersion }`
}</CodeBlock>
