...
<AutomatedInstall label="Windows" isWindows={ props.isWindows }/>

<CodeBlock language="console"> {
`C:\> tree /f %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\openocd\\${ siteConfig.customFields.upstreamVersion }-${ siteConfig.customFields.xpackSubversion }.${ siteConfig.customFields.npmSubversion }\\.content
Folder PATH listing
...
<CodeBlock language="console"> {
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\openocd\\${ siteConfig.customFields.upstreamVersion }-${ siteConfig.customFields.xpackSubversion }.${ siteConfig.customFields.npmSubversion }\\.content\\bin\\openocd.exe --version
...
<CodeBlock language="console"> {
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\openocd\\xpack-openocd-${ siteConfig.customFields.upstreamVersion }-${ siteConfig.customFields.xpackSubversion }\\bin\\openocd.exe --version
${ siteConfig.customFields.upstreamVersion }`
}</CodeBlock>
