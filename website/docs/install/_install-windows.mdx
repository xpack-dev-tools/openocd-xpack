...
<InstallEasy isWindows={ props.isWindows }/>

<InstallWindowsTree upstreamVersion={ props.upstreamVersion } xpackSubversion={ props.xpackSubversion } npmSubversion={ props.npmSubversion }/>
...
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\openocd\\${ props.upstreamVersion }-${ props.xpackSubversion }.${ props.npmSubversion }\\.content\\bin\\openocd.exe --version
...
* <code>xpack-openocd-{ props.upstreamVersion }-{ props.xpackSubversion }-win32-x64.zip</code>
...
<code>%USERPROFILE%\\AppData\\Roaming\\xPacks\\openocd\\xpack-openocd-{ props.upstreamVersion }-{ props.xpackSubversion }</code> folder
(for example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\openocd\\xpack-openocd-{ props.upstreamVersion }-{ props.xpackSubversion }</code>);
...
<CodeBlock language="console"> {
`C:\\> %USERPROFILE%\\AppData\\Roaming\\xPacks\\openocd\\xpack-openocd-${ props.upstreamVersion }-${ props.xpackSubversion }\\bin\\openocd.exe --version
${ props.upstreamVersion }`
}</CodeBlock>
