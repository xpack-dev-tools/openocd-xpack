...
Determine the version (like <code>{ customFields.upstreamVersion }</code>) and update the `scripts/VERSION`
file; the format is <code>{ customFields.upstreamVersion }-{ customFields.xpackSubversion }</code>. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like <code>{ customFields.upstreamVersion }-{ customFields.xpackSubversion }</code>).
...
Use the new version, suffixed by `.pre`, like <code>{ customFields.upstreamVersion }-{ customFields.xpackSubversion }.{ customFields.npmSubversion }.pre</code>.

### Update `CHANGELOG.md`

- open the `CHANGELOG.md` file
- check if all previous fixed issues are in
- add a new entry like _* v{ customFields.upstreamVersion }-{ customFields.xpackSubversion } prepared_
- commit with a message like _prepare v{ customFields.upstreamVersion }-{ customFields.xpackSubversion }_
...
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-darwin-x64.tar.gz</code>
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-darwin-x64.tar.gz.sha</code>
...
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-darwin-arm64.tar.gz</code>
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-darwin-arm64.tar.gz.sha</code>
...
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-linux-x64.tar.gz</code>
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-linux-x64.tar.gz.sha</code>
...
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-win32-x64.zip</code>
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-win32-x64.zip.sha</code>
...
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-linux-arm64.tar.gz</code>
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-linux-arm64.tar.gz.sha</code>
...
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-linux-arm.tar.gz</code>
* <code>xpack-openocd-{ customFields.upstreamVersion }-{ customFields.xpackSubversion }-linux-arm.tar.gz.sha</code>
...
`$ .../xpack-openocd-${ customFields.upstreamVersion }-${ customFields.xpackSubversion }/bin/openocd -f "board/stm32f4discovery.cfg"
...
- in `CHANGELOG.md`, add the release date and a message like _* v{ customFields.upstreamVersion }-{ customFields.xpackSubversion } released_
...
tagged like **v{ customFields.upstreamVersion }-{ customFields.xpackSubversion }** (mind the dash in the middle!) and
named like **xPack OpenOCD v{ customFields.upstreamVersion }-{ customFields.xpackSubversion }** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack OpenOCD v{ customFields.upstreamVersion }-{ customFields.xpackSubversion } released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for { customFields.upstreamVersion }-{ customFields.xpackSubversion }.{ customFields.npmSubversion } release_ (without _v_)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _* v{ customFields.upstreamVersion }-{ customFields.xpackSubversion } published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v{ customFields.upstreamVersion }-{ customFields.xpackSubversion }.{ customFields.npmSubversion }_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- <code>npm version { customFields.upstreamVersion }-{ customFields.xpackSubversion }.{ customFields.npmSubversion }</code>; the first 4 numbers are the same as the
...
- <code>npm dist-tag add @xpack-dev-tools/openocd@{ customFields.upstreamVersion }-{ customFields.xpackSubversion }.{ customFields.npmSubversion } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/openocd</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/openocd@{ customFields.upstreamVersion }-{ customFields.xpackSubversion }.{ customFields.npmSubversion }</code>
...
- paste the release name like **xPack OpenOCD v{ customFields.upstreamVersion }-{ customFields.xpackSubversion } released**
