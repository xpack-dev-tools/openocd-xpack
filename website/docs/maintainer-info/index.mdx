...
Determine the version (like <code>{ siteConfig.customFields.upstreamVersion }</code>) and update the `scripts/VERSION`
file; the format is <code>{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }</code>. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like <code>{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }</code>).
...
Use the new version, suffixed by `.pre`, like <code>{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }.{ siteConfig.customFields.npmSubversion }.pre</code>.

### Update `CHANGELOG.md`

- open the `CHANGELOG.md` file
- check if all previous fixed issues are in
- add a new entry like _* v{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion } prepared_
- commit with a message like _prepare v{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }_
...
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-darwin-x64.tar.gz</code>
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-darwin-x64.tar.gz.sha</code>
...
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-darwin-arm64.tar.gz</code>
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-darwin-arm64.tar.gz.sha</code>
...
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-linux-x64.tar.gz</code>
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-linux-x64.tar.gz.sha</code>
...
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-win32-x64.zip</code>
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-win32-x64.zip.sha</code>
...
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-linux-arm64.tar.gz</code>
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-linux-arm64.tar.gz.sha</code>
...
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-linux-arm.tar.gz</code>
* <code>xpack-openocd-{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }-linux-arm.tar.gz.sha</code>
...
`sudo cp ~/Downloads/xpack-openocd-${ siteConfig.customFields.upstreamVersion }-${ siteConfig.customFields.xpackSubversion }/contrib/60-openocd.rules /etc/udev/rules.d
...
`$ .../xpack-openocd-${ siteConfig.customFields.upstreamVersion }-${ siteConfig.customFields.xpackSubversion }/bin/openocd -f "board/stm32f4discovery.cfg"
xPack Open On-Chip Debugger ${ siteConfig.customFields.upstreamVersion }-01004-g9ea7f3d64-dirty
...
- in `CHANGELOG.md`, add the release date and a message like _* v{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion } released_
...
tagged like **v{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }** (mind the dash in the middle!) and
named like **xPack OpenOCD v{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack OpenOCD v{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion } released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for { siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }.{ siteConfig.customFields.npmSubversion } release_ (without _v_)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _* v{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion } published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }.{ siteConfig.customFields.npmSubversion }_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- <code>npm version { siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }.{ siteConfig.customFields.npmSubversion }</code>; the first 4 numbers are the same as the
...
- <code>npm dist-tag add @xpack-dev-tools/openocd@{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }.{ siteConfig.customFields.npmSubversion } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/openocd</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/openocd@{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion }.{ siteConfig.customFields.npmSubversion }</code>
...
- paste the release name like **xPack OpenOCD v{ siteConfig.customFields.upstreamVersion }-{ siteConfig.customFields.xpackSubversion } released**
