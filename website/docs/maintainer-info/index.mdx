...
- check and possibly update the `build-assets/templates/body-github-release-liquid.md`
...
- run the xPack action `generate-website-blog-post`; this will add a file
...
- Subject: **xPack OpenOCD v{ customField('upstreamVersion') }-{ customField('xpackSubversion') } released**
