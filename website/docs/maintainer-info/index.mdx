...
Determine the version (like <code>{ customFields.version }</code>) and update the `scripts/VERSION`
file; the format is <code>{ customFields.version }-{ customFields.xpack_subversion }</code>. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like <code>{ customFields.version }-{ customFields.xpack_subversion }</code>).
...
Use the new version, suffixed by `pre`, like <code>{ customFields.version }-{ customFields.xpack_subversion }.pre</code>.

### Update `CHANGELOG.md`

- open the `CHANGELOG.md` file
- check if all previous fixed issues are in
- add a new entry like _* v{ customFields.version }-{ customFields.xpack_subversion } prepared_
- commit with a message like _prepare v{ customFields.version }-{ customFields.xpack_subversion }_
...
total 4552
-rw-r--r--  1 ilg  staff  2325140 Apr  2 01:09 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff      107 Apr  2 01:09 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-darwin-x64.tar.gz.sha`
}</CodeBlock>
...
total 4400
-rw-r--r--  1 ilg  staff  2245438 Apr  2 01:08 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-darwin-arm64.tar.gz
-rw-r--r--  1 ilg  staff      109 Apr  2 01:08 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-darwin-arm64.tar.gz.sha`
}</CodeBlock>
...
total 2548
-rw-r--r-- 1 ilg ilg 2604809 Apr  1 22:07 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-linux-x64.tar.gz
-rw-r--r-- 1 ilg ilg     106 Apr  1 22:07 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-linux-x64.tar.gz.sha`
}</CodeBlock>
...
total 2972
-rw-r--r-- 1 ilg ilg 3037341 Apr  1 22:08 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-win32-x64.zip
-rw-r--r-- 1 ilg ilg     103 Apr  1 22:08 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-win32-x64.zip.sha`
}</CodeBlock>
...
total 2500
-rw-r--r-- 1 ilg ilg 2553855 Apr  1 22:17 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-linux-arm64.tar.gz
-rw-r--r-- 1 ilg ilg     108 Apr  1 22:17 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-linux-arm64.tar.gz.sha`
}</CodeBlock>
...
total 2424
-rw-r--r-- 1 ilg ilg 2477121 Apr  1 22:16 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-linux-arm.tar.gz
-rw-r--r-- 1 ilg ilg     106 Apr  1 22:16 xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }-linux-arm.tar.gz.sha`
}</CodeBlock>
...
<CodeBlock language="console"> {
`$ .../xpack-openocd-${ customFields.version }-${ customFields.xpack_subversion }/bin/openocd -f "board/stm32f4discovery.cfg"
...
- in `CHANGELOG.md`, add the release date and a message like _* v{ customFields.version }-{ customFields.xpack_subversion } released_
...
tagged like **v{ customFields.version }-{ customFields.xpack_subversion }** (mind the dash in the middle!) and
named like **xPack OpenOCD v{ customFields.version }-{ customFields.xpack_subversion }** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like _xPack OpenOCD v{ customFields.version }-{ customFields.xpack_subversion } released_
- push to GitHub
...
- commit all changes, use a message like
  _package.json: update urls for { customFields.version }-{ customFields.xpack_subversion }.{ customFields.npm_subversion } release_ (without _v_)

## Publish on the npmjs.com server

- select the `xpack-develop` branch
- check the latest commits `npm run git-log`
- update `CHANGELOG.md`, add a line like _* v{ customFields.version }-{ customFields.xpack_subversion } published on npmjs.com_
- commit with a message like _CHANGELOG: publish npm v{ customFields.version }-{ customFields.xpack_subversion }.{ customFields.npm_subversion }_
- `npm pack` and check the content of the archive, which should list
  only the `package.json`, the `README.md`, `LICENSE` and `CHANGELOG.md`;
  possibly adjust `.npmignore`
- <code>npm version { customFields.version }-{ customFields.xpack_subversion }.{ customFields.npm_subversion }</code>; the first 4 numbers are the same as the
...
- <code>npm dist-tag add @xpack-dev-tools/openocd@{ customFields.version }-{ customFields.xpack_subversion }.{ customFields.npm_subversion } latest</code>
- <code>npm dist-tag ls @xpack-dev-tools/openocd</code>

In case the previous version is not functional and needs to be unpublished:

- <code>npm unpublish @xpack-dev-tools/openocd@{ customFields.version }-{ customFields.xpack_subversion }.{ customFields.npm_subversion }</code>
...
- paste the release name like **xPack OpenOCD v{ customFields.version }-{ customFields.xpack_subversion } released**
