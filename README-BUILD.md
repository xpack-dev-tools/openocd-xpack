...
The version string is an extension to semver, the format looks like `0.11.0-5`.
...
```sh
bash ${HOME}/Work/openocd-xpack.git/scripts/helper/build.sh preload-images
```
...
total 13248
-rw-rw-rw- 1 ilg ilg 3601358 Jun 10 13:45 xpack-openocd-0.11.0-5-linux-x64.tar.gz
-rw-rw-rw- 1 ilg ilg     107 Jun 10 13:45 xpack-openocd-0.11.0-5-linux-x64.tar.gz.sha
-rw-rw-rw- 1 ilg ilg 3133169 Jun 10 13:51 xpack-openocd-0.11.0-5-win32-x64.zip
-rw-rw-rw- 1 ilg ilg     104 Jun 10 13:51 xpack-openocd-0.11.0-5-win32-x64.zip.sha
```
...
$ ls -l ~/Work/openocd-*-*/deploy
total 7120
-rw-rw-rw- 1 ilg ilg 3632743 Mar 26 15:25 xpack-openocd-0.11.0-5-linux-arm64.tar.gz
-rw-rw-rw- 1 ilg ilg     109 Mar 26 15:25 xpack-openocd-0.11.0-5-linux-arm64.tar.gz.sha
-rw-rw-rw- 1 ilg ilg 3646739 Mar 26 15:50 xpack-openocd-0.11.0-5-linux-arm.tar.gz
-rw-rw-rw- 1 ilg ilg     107 Mar 26 15:50 xpack-openocd-0.11.0-5-linux-arm.tar.gz.sha
```
...
$ ls -l ~/Work/openocd-*-*/deploy
total 5536
-rw-r--r--  1 ilg  staff  2828202 Jun 10 17:44 xpack-openocd-0.11.0-5-darwin-x64.tar.gz
-rw-r--r--  1 ilg  staff      108 Jun 10 17:44 xpack-openocd-0.11.0-5-darwin-x64.tar.gz.sha
```
...
```sh
bash ${HOME}/Work/openocd-xpack.git/scripts/helper/build.sh --all clean
```

To also remove the library build temporary files, use:

```sh
bash ${HOME}/Work/openocd-xpack.git/scripts/helper/build.sh --all cleanlibs
```

To remove all temporary files, use:

```sh
bash ${HOME}/Work/openocd-xpack.git/scripts/helper/build.sh --all cleanall
```
...
```console
$ .../xpack-openocd-0.11.0-5/bin/openocd --version
