...
```console
$ tree -L 2 /Users/ilg/Library/xPacks/\@xpack-dev-tools/openocd/0.12.0-2.1/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/openocd/0.12.0-2.1/.content/
├── README.md
├── bin
│   └── openocd
├── distro-info
...
like `0.12.0-2`. When published as a npm package, the version gets
a fifth number, like `0.12.0-2.1`.

Since adherence of third party packages to semver is not guaranteed,
it is recommended to use semver expressions like `^0.12.0` and `~0.12.0`
with caution, and prefer exact matches, like `0.12.0-2.1`.
